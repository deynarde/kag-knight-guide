...
In case the gap is under or above you, you want to slash slightly to the side. This is a bit confusing, but it's due to how slash arcs work. You have more range when slashing sideways because of where the slash hitbox is attached to.
