...
Slashes have a duration after releasing -- this means that the arc (angle) of the slash can be moved for a very short while after releasing left mouse button. Here's how it looks with `g_debug 2` in Sandbox:
...
Throw a bomb behind the enemy when they have 1 heart and then jab them while they're trying to shield it.
