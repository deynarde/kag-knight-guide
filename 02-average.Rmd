...
<video style="display:block; max-width:100%; height:auto;" src="webm/02-good/qslide.webm" controls loop="loop" preload></video><br>
...
<video style="display:block; max-width:100%; height:auto;" src="webm/02-good/airarrow.webm" controls loop="loop" preload></video><br>

### Using walls for extra velocity

Pushing off a wall will give you a small burst of speed. This speed boost can be extremely helpful to win battles by utilising slash timings. It's also good against people playing defensively.

[GIF]

### Making use of enemies opening doors
...
<video style="display:block; max-width:100%; height:auto;" src="webm/02-good/durthru3.webm" controls loop="loop" preload></video><br>
...
Slashing can sometimes be used as an escape mechanism due to the small speed boost it gives. This is usually done when you start charging a slash but notice that the enemy is more likely to hit you due to him starting charging a slash earlier as well as being too close to you -- you avoid getting hit by slash escaping.
...
You can do the same after successful double slashes when the enemy was shielding.
